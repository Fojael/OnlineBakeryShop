        ...
        <DashboardLayout>
            <div className="container-fluid py-4 offline-report-page">
                <div className="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                    <div><h2 className="mb-1">{report?.report || "Offline Sales Reports"}</h2><p className="text-muted mb-0">Persisted counter sales only.</p><p className="offline-report-generated mb-0">Period: {report?.period?.start_date || "-"} to {report?.period?.end_date || "-"} · Generated: {new Date().toLocaleString()}</p></div>
                    <div className="offline-report-actions d-flex gap-2"><button type="button" className="btn btn-outline-primary" onClick={() => window.print()} disabled={!report}>Print Report</button><button type="button" className="btn btn-outline-secondary" onClick={() => void downloadReport()} disabled={!report}>Download</button><Link className="btn btn-primary" to="/admin/offline-sales">Create Offline Sale</Link></div>
                </div>
                ...
                {report && <div className="row g-3 mb-4"><div className="col-sm-6 col-xl-3"><div className="border rounded p-3 bg-white"><div className="text-muted small">Offline Revenue</div><strong>৳{report.sales.total_sales}</strong></div></div><div className="col-sm-6 col-xl-3"><div className="border rounded p-3 bg-white"><div className="text-muted small">Completed Sales</div><strong>{report.sales.completed_sales}</strong></div></div><div className="col-sm-6 col-xl-3"><div className="border rounded p-3 bg-white"><div className="text-muted small">Units Sold</div><strong>{report.sales.total_units}</strong></div></div><div className="col-sm-6 col-xl-3"><div className="border rounded p-3 bg-white"><div className="text-muted small">Average Sale</div><strong>৳{report.sales.average_sale}</strong></div></div></div>}
